...
> [!WARNING]
> **تنبيه هام جداً:** هذا السكربت مصمم **حصرياً** لتوزيعة Arch Linux أو التوزيعات المبنية عليها. تشغيل هذا السكربت على Ubuntu أو Fedora أو غيرها قد يؤدي إلى إتلاف نظامك!
...
> **ملاحظة بخصوص الإسبات (Hibernation):** النظام يستخدم ZRAM بشكل افتراضي لتوفير مساحة الرام وسرعة الأداء. إذا اخترت نظام ملفات Btrfs وكنت ترغب في تفعيل خاصية الإسبات (Hibernation) في المستقبل، ستحتاج إلى إعداد Swapfile مخصص بطريقة معينة تتناسب مع Btrfs.
...
لو زهقت أو حسيت إنك عايز ترجع لنظامك القديم، السكربت ده هيرجعلك كل حاجة زي ما كانت قبل التسطيب:
```bash
./uninstall.sh
```
*(ملاحظة: السكربت هيسألك إذا كنت عايز تمسح البرامج اللي نزلتها، وتقدر تختار لا عشان تحافظ على برامجك الأساسية وتلغي بس الـ Theme والـ Dotfiles).*
