...
```
> **ملاحظة:** الاسكريبت هيسألك هتنزل النظام على أنهي هارد، وبعدها هيفرمت، ينزل Arch، يعمل الإعدادات الأساسية (الشبكة، الوقت، المستخدم nooreldean) ويظبط كل حاجة أوتوماتيك!
