...
hl.bind(mainMod .. " + SHIFT + D", hl.dsp.exec_cmd("~/.config/hypr/scripts/display_switcher.sh"))
...
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd("~/.config/hypr/scripts/audio_switcher.sh"))
